---
name: aios-support-knowledge
description: AIOS Support 插件的内部方法论、来源策略、回答契约和仓库路由知识。由其他技能引用，不作为用户直接入口。
---
...
- [source-policy.md](references/source-policy.md)：来源适用范围和冲突处理。
